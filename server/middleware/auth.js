...
if (Object.keys(req.cookies).length === 0 || !req.cookies.shortlyid) {
  ...
  var hashData = req.cookies.shortlyid;
  req.session = {hash: hashData};

  return models.Sessions.get({hash: hashData})
  .then((data) => {
    if (!data) {
      req.cookies = {};
      return models.Sessions.create()
